...
{
    public static string Core = "Core Soul";
    /// <summary>A hit soul</summary>
    public static string Fight = "Fight Soul";
    /// <summary>A auto-generate soul</summary>
    public static string Sustain = "Sustain Soul";
    // /// <summary>A 3-combo Soul</summary>
    // public static string Burst = "Burst Soul";
